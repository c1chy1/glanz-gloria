<template>
  <div class="w-full">
    <div class="max-w-7xl mx-auto lg:px-8 sm:px-6 px-4 text-gray-500 py-32 prose font-restaurant">
      ...
      <p>Isa Uzunay<br/>
        Berliner Stra&szlig;e 40<br/>
        51377 Leverkusen</p>

      <p>Telefon: 0214 311 98 460<br/>
        E-Mail: Isa.uzunay@web.de</p>
      ...
      <p>Der Nutzung von im Rahmen der Impressumspflicht ver&ouml;ffentlichten Kontaktdaten zur &Uuml;bersendung von
        ...
        Betreiber der Seiten behalten sich ausdr&uuml;cklich rechtliche Schritte im Falle der unverlangten Zusendung von
      ...
      <p>Cookies, die zur Durchf&uuml;hrung des elektronischen Kommunikationsvorgangs (notwendige Cookies) oder zur
        ...
        auf Grundlage dieser Einwilligung (Art. 6 Abs. 1 lit. a DSGVO); die Einwilligung ist jederzeit widerrufbar.</p>
      ...
      <p>Die Nutzung von Google Maps erfolgt im Interesse einer ansprechenden Darstellung unserer Online-Angebote und an
        ...
        erfolgt die Verarbeitung ausschlie&szlig;lich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO; die Einwilligung ist
